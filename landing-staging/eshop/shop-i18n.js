(function () {
  ...
  var copy = {
    cs: {
      ...
      mealVoucherTitle: 'Přijímáte stravenky?', mealVoucherHint: 'Volbu předáme supportu v poznámce objednávky, aby mohl zařídit smlouvy.', mealVoucherAnswers: ['Ano', 'Ne'], mealVoucherProvidersTitle: 'Vyberte alespoň jednoho poskytovatele', mealVoucherProviders: ['Edenred', 'Sodexo', 'UP', 'Pluxee / Naše stravenka', 'Benefit Plus'], mealVoucherPreparing: 'Připravujeme',
    ...
    en: {
      ...
      mealVoucherTitle: 'Do you accept meal vouchers?', mealVoucherHint: 'We will add this choice to the order note so support can arrange the contracts.', mealVoucherAnswers: ['Yes', 'No'], mealVoucherProvidersTitle: 'Choose at least one provider', mealVoucherProviders: ['Edenred', 'Sodexo', 'UP', 'Pluxee / Naše stravenka', 'Benefit Plus'], mealVoucherPreparing: 'Coming soon',
  ...
  var entries = [
    ...
    ['.meal-voucher-choice legend', 'text', 'mealVoucherTitle'], ['.meal-voucher-hint', 'text', 'mealVoucherHint'], ['.meal-voucher-answer span', 'allText', 'mealVoucherAnswers'],
    ['.meal-voucher-providers > strong', 'text', 'mealVoucherProvidersTitle'], ['.meal-voucher-providers label > span', 'allText', 'mealVoucherProviders'], ['.meal-voucher-providers small', 'text', 'mealVoucherPreparing'],
